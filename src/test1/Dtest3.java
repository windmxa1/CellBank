...
public class Dtest3 {
	...
	public static void SubmitPost(String url, String filename1,
			String filename2, String filepath) {
...
//					+ filename2),"image/jpg");
			File file = new File("G://app-photo//up//1.jpg");
			ContentBody file1 = new FileBody(file,"image/jpg");
			StringBody comment = new StringBody(filename1);
			
			MultipartEntity reqEntity = new MultipartEntity();

			reqEntity.addPart("file1", file1);// file1为请求后台的File upload;属性
//			reqEntity.addPart("file2", bin2);// file2为请求后台的File upload;属性
	...
	public static void main(String[] args) {
		...
		SubmitPost(
				"http://127.0.0.1:8080/CellBank/photoUp.action", "1.jpg",
				"2.jpg", "G://app-photo//up");
	}
